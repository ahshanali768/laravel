...
<div class="container py-4">
    <h2 class="mb-4 fw-bold" style="color:#2a5298;">Edit Campaign</h2>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.campaigns.update', $campaign->id) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="payout_amount" class="form-control" step="0.01" min="0" value="{{ $campaign->payout_amount }}" required>
                </div>
                <button type="submit" class="btn btn-primary px-4 me-2"><i class="bi bi-save me-1"></i>Update</button>
