        ...
        <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false" aria-label="User menu">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name ?? 'User')); ?>&background=232946&color=fff" class="user-avatar me-2 border border-2 border-primary" alt="User">
                    <span class="fw-semibold d-none d-md-inline"><?php echo e(Auth::user()->name ?? 'User'); ?></span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                    ...
                    <li>
                        <form method="POST" action="<?php echo e(route('logout')); ?>" class="d-inline"><?php echo csrf_field(); ?>
...
<div class="d-flex" style="min-height:100vh;">
    ...
    <div class="offcanvas-lg offcanvas-start sidebar p-0 border-0" tabindex="-1" id="sidebarOffcanvas" aria-labelledby="sidebarOffcanvasLabel" style="width:250px !important;box-shadow:2px 0 16px 0 rgba(30,60,114,0.08);background:linear-gradient(180deg,#1e3c72 0%,#2a5298 100%);transition:width 0.2s;">
        ...
        <nav class="h-100 d-flex flex-column align-items-start" style="width:250px !important;">
            <ul class="nav nav-pills flex-column mb-auto w-100">
                ...
                <li class="nav-item mb-2">
                    <a href="/admin/leads" class="nav-link d-flex align-items-center py-3<?php echo e(request()->is('admin/leads') ? ' active' : ''); ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="View Leads">
                        <i class="bi bi-person-lines-fill fs-4 me-2"></i>
                        <span class="sidebar-label">View Leads</span>
                    </a>
                </li>
                <li class="nav-item mb-2">
                    <a href="/admin/reports" class="nav-link d-flex align-items-center py-3<?php echo e(request()->is('admin/reports') ? ' active' : ''); ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="Reports">
                        <i class="bi bi-bar-chart-line fs-4 me-2"></i>
                        <span class="sidebar-label">Reports</span>
                    </a>
                </li>
                <li class="nav-item mb-2">
                    <a href="/admin/payment" class="nav-link d-flex align-items-center py-3<?php echo e(request()->is('admin/payment') ? ' active' : ''); ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="Payment">
                        <i class="bi bi-credit-card fs-4 me-2"></i>
                        <span class="sidebar-label">Payment</span>
                    </a>
                </li>
                <li class="nav-item mb-2">
                    <a href="/admin/settings" class="nav-link d-flex align-items-center py-3<?php echo e(request()->is('admin/settings') ? ' active' : ''); ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="Settings">
        ...
        <?php endif; ?>
        <!-- Agent Sidebar -->
        <?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'agent')): ?>
        <nav class="h-100 d-flex flex-column align-items-center" style="width:250px !important;">
            <ul class="nav nav-pills flex-column mb-auto w-100">
                <li class="nav-item mb-2">
                    <a href="/agent/dashboard" class="nav-link d-flex flex-column align-items-center py-3<?php echo e(request()->is('agent/dashboard') ? ' active' : ''); ?>" data-bs-toggle="tooltip" data-bs-placement="right" title="Dashboard">
...
<?php /**PATH /home/ahshanali768/laravel/resources/views/layouts/app.blade.php ENDPATH**/ ?>